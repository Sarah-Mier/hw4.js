...
export default class App extends React.Component {
  ...
  async getWeather() {
    ...
    this.setState({
      ...
      currentIcon: icon(response.weather.currently),
  ...
  render() {
    ...
    let forecast = [
      for (let x=1; x<6; x++) {
          <View style={styles.forecastDay} key={x}>
            <Text style={styles.forecastIcon}><Icon size={30} name={icon(this.state.forecast[x].icon)} /></Text>
            <Text style={styles.forecastTemperature}>{Math.round(this.state.forecast[x].temperatureHigh)}</Text>
          </View>
        ];
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.currentWeather}>
          ...
          <Text style={styles.currentIcon}><Icon size={30} name={icon(this.state.currentIcon)} /></Text>
